const copy = {
  ko: {
    title: "퍼즐을 풀어 별빛을 모으고,<br><strong>멈춰버린 밤에 아침을 불러오세요.</strong>", body: "숫자 속에 흩어진 별빛을 모아 잠든 마을의 장소들을 하나씩 밝혀 나가는 감성 스도쿠 게임입니다.", cta: "상세 페이지 보기", playCta: "지금<br>플레이해보세요", skip: "본문으로 이동", pageTitle: "별빛 스도쿠 | Starlight Sudoku",
  ...
  "zh-CN": {
    title: "解开谜题，收集星光，<br><strong>让清晨重回停驻的长夜。</strong>", body: "在数字中找回散落的星光，逐一照亮沉睡小镇的治愈系数独游戏。", cta: "查看游戏详情", playCta: "立即<br>试玩", skip: "跳至正文", pageTitle: "星光数独 | Starlight Sudoku",
  ...
  "zh-TW": {
    title: "解開謎題，收集星光，<br><strong>讓清晨重回停駐的長夜。</strong>", body: "在數字中找回散落的星光，逐一照亮沉睡小鎮的療癒系數獨遊戲。", cta: "查看遊戲詳情", playCta: "立即<br>試玩", skip: "跳至主要內容", pageTitle: "星光數獨 | Starlight Sudoku",
  ...
  ja: {
    title: "パズルを解いて星の光を集め、<br><strong>止まった夜に朝を呼び戻そう。</strong>", body: "数字の中に散った星の光を集め、眠る村を一つずつ照らしていく心温まる数独ゲームです。", cta: "ゲーム詳細を見る", playCta: "今すぐ<br>プレイ", skip: "本文へ移動", pageTitle: "星光数独 | Starlight Sudoku",
