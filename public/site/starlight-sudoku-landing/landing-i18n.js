const copy = {
  ...
  "zh-CN": {
    title: "解开谜题，收集星光，<br><strong>让清晨重回停驻的长夜。</strong>", body: "在数字中找回散落的星光，逐一照亮沉睡小镇的治愈系数独游戏。", cta: "查看游戏详情", playCta: "立即<br>试玩", releaseState: "GOOGLE PLAY · 上架准备中", skip: "跳至正文", pageTitle: "星光数独 | Starlight Sudoku",
  ...
  "zh-TW": {
    title: "解開謎題，收集星光，<br><strong>讓清晨重回停駐的長夜。</strong>", body: "在數字中找回散落的星光，逐一照亮沉睡小鎮的療癒系數獨遊戲。", cta: "查看遊戲詳情", playCta: "立即<br>試玩", releaseState: "GOOGLE PLAY · 上架準備中", skip: "跳至主要內容", pageTitle: "星光數獨 | Starlight Sudoku",
